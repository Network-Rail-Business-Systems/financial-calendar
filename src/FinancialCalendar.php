 ...
 * @property-read int $dayWeekEnds The day the week ends in numeric form
 * @property-read int $dayWeekStarts The day the week starts in numeric form
...
{
    public const int PERIODS_PER_YEAR = 13;
    ...
    public function modulo(int $value, int $dividend): int
    {
